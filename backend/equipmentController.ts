...
export class EquipmentController {
  ...
  static async createEquipment(req: Request, res: Response): Promise<void> {
    ...
    try {
      ...
      // Note: La vérification du fichier image est maintenant gérée par requirePhotoUpload middleware
   ...
   */
  static async getAllEquipments(req: Request, res: Response): Promise<void> {
    ...
    try {
      ...
      if (search) {
        where.OR = [
          ...
          { numeroInventaire: { contains: search as string, mode: 'insensitive' } },
          { typeMateriel: { contains: search as string, mode: 'insensitive' } }
        ];
  ...
  static async updateEquipment(req: Request, res: Response): Promise<void> {
    ...
    try {
      ...
      if (req.body.numeroInventaire !== undefined) updateData.numeroInventaire = req.body.numeroInventaire || null;
      if (req.body.typeMateriel !== undefined) updateData.typeMateriel = req.body.typeMateriel || null;
   ...
   */
  static async regenerateQRCode(req: Request, res: Response): Promise<void> {
   ...
   */
  static async getQRCodeBase64(req: Request, res: Response): Promise<void> {
