...
export class InterventionController {
   ...
   */
  static async getAllInterventions(req: Request, res: Response) {
    ...
    try {
      ...
      if (typeIntervention && ['MAINTENANCE', 'REPARATION', 'INSPECTION'].includes(typeIntervention as string)) {
   ...
   */
  static async getInterventionById(req: Request, res: Response) {
   ...
   */
  static async validateIntervention(req: Request, res: Response) {
   ...
   */
  static async getEquipmentInterventions(req: Request, res: Response) {
